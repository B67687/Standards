    ...
    cat > "${eval_dir}/readme-quality-section-order.json" << AGENTJSON
{
  ...
  "repo": $(_json_str "${repo}"),
  "target": "README.md",
  "prompt": "Evaluate whether README.md follows the standard section order. The standard order is: 1. Title (H1), 2. Tech Badges (CI, language/tech stack, license), 3. Short Description (12 sentences), 4. Stats Line (optional), 5. AI Attribution + AI Model Badges ('Built with AI assistance' then model/harness badges), 6. Hero Screenshot/Image, 7. Table of Contents (>100 lines), 8. Features, 9. Quick Start, 10. Usage, 11. Architecture, 12. Contributing, 13. Optional sections, 14. Changelog link, 15. License (LAST). Which sections are present, which are missing, which are out of order?",
  "context": {
